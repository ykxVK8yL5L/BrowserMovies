...
public class MySearchFragment extends Fragment {
    static final String TAG = MySearchFragment.class.getSimpleName();
    static final boolean DEBUG = false;

    private static final String EXTRA_LEANBACK_BADGE_PRESENT = "LEANBACK_BADGE_PRESENT";
    private static final String ARG_PREFIX = MySearchFragment.class.getCanonicalName();
    ...
    private SearchBar.SearchBarPermissionListener mPermissionListener =
            new SearchBar.SearchBarPermissionListener() {
                ...
                public void requestAudioPermission() {
                    PermissionHelper.requestPermissions(MySearchFragment.this, new String[]{Manifest.permission.RECORD_AUDIO},
     ...
     */
    public static MySearchFragment newInstance(String query) {
...
//        list.setFocusableInTouchMode(false);
    ...
    public void onResume() {
        ...
        if (mSpeechRecognitionCallback == null && null == mSpeechRecognizer) {
            mSpeechRecognizer = SpeechRecognizer.createSpeechRecognizer(FragmentUtil.getContext(MySearchFragment.this));
